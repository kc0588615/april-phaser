...
import { AssetKeys } from '../constants'; // Use constants for assets
...
export class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(centerX, centerY, 'Phaser Match-3', {
            ...
            fontSize: Math.min(width * 0.08, height * 0.1), // Responsive font size
            color: '#ffffff',
            stroke: '#111111',
            strokeThickness: 6,
            align: 'center'
        ...
        const startText = this.add.text(centerX, centerY * 1.5, 'Click or Tap to Start', {
            fontFamily: 'Arial',
            fontSize: Math.min(width * 0.05, height * 0.06),
            color: '#eeeeee',
            align: 'center'
        }).setOrigin(0.5);
